#undef ARTDISPLAYER_API
#undef ARTDISPLAYER_VTABLE
...
#define UE_PROJECT_NAME FrogGame
...
#define ARTDISPLAYER_VTABLE DLLEXPORT_VTABLE
#define ARTDISPLAYER_API DLLEXPORT
